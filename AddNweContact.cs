...
{
	internal  class AddNweContact
	{
		private List<CreateContact> ContactList;            // Declearing Arraylist with Model Class  

		public AddNweContact()
		{
			ContactList = new List<CreateContact>();        // Initaillizing Arraylist 
		}
		...
		public CreateContact GetContactInput()                      // Getting a Input from User
		{
			...
			CreateContact contact = new CreateContact(fname, lname, address, city, state, zip, phoneNo, email);
			return contact;
		}
